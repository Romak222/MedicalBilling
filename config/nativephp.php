...
return [
     ...
     */
    'version' => env('NATIVEPHP_APP_VERSION', env('APP_VERSION', '0.5.0-phase5')),
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'in.medstore.foundation'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'MedStore'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright '.date('Y').' MedStore'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Offline-first pharmacy management desktop application foundation.'),
