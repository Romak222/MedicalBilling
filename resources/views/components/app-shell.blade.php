...
@php
    ...
    $navItems = [
        ...
        ['label' => 'Purchases', 'mark' => 'B', 'route' => $canViewPurchases ? route('purchase-invoices.index') : null, 'active' => request()->routeIs('purchases.*', 'purchase-orders.*', 'purchase-invoices.*'), 'enabled' => $canViewPurchases],
        ...
        ['label' => 'Settings', 'mark' => 'G', 'route' => null, 'active' => false, 'enabled' => false],
    ];
@endphp
